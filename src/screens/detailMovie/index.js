...
class DetailMovie extends Component {
  ...
  componentDidMount() {
    ...
    this.checkLike(itemMovie.id, "admin")
    fetch(
  ...
  postLike(id_movie, nameuser) {
    postLike(id_movie, nameuser, this.cbSss);
  }
  checkLike(id_movie, name){
    postLike(id_movie, name, this.cbSsscheckluu);
  }
  showComment() {
    this.setState({ isLoadingComment: true });
    showComment(this.callBackSuccess);
  }
  postComment(id) {
    postComment(this.state.textcomment, id, "x", this.cbSuccess);
  }
  cbSsscheckluu = data => {
          ...
          >
            ...
            >
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() => this.postLike(itemMovie.id, itemMovie.original_title)}
